...
export default function Cart(props) {
    ...
    const statePattern = /^[A-Za-z ]{3,}$/;
        ...
        const removeItem = (item) => { debugger
          ...
          services.deleteCartItem(item._id)
          .then((item)=> {
   ...
   <div>    
     {/* <cartItemLength.Provider value={{cartlength : cartBooks}}>
            <AppBar/>
            </cartItemLength.Provider>     */}
 ...
 <div class="card">
     ...
     {detailForm ? (
          ...
          <div className="blockButton">
            <button type="button" class="btn btn-primarycart"
...
<form>
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      type="email" class="form-controlcart" id="inputEmail4" placeholder="Full Name"/>
    ...
    <div class="form-group col-md-6">
      ...
      type="password" class="form-controlcart" id="inputPassword4" placeholder="Mobile Number"/>
  ...
  <div class="form-groupcart">
    ...
    <input
     ...
     type="text" class="form-controlcart1" id="inputAddress" placeholder="Address"/>
  ...
  <div class="form-row">
    <div class="form-groupcart col-md-6">
      ...
      type="text" class="form-controlcart" id="inputCity" placeholder="City/Town"/>
    ...
    <div class="form-groupcart col-md-6">
      ...
      type="text" class="form-controlcart" id="inputCity " placeholder="State"/>
        ...
        {summaryField ? (
          <>
            ...
            <div className="blockButtonorder">
              <button
              type="button" class="btn btn-primarycart"
              onClick={checkout}
