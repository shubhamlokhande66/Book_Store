...
//        errors.mobilenumber = "  Please Enter Valid Phone No. Enter Minimum 10 digit ";
//        validate = true;
//    } else {
//        errors.mobilenumber = "";
//    }this.setState({
...
//                     error={this.state.errorValid.fullName}
                   
//                     helperText={this.state.errors["fullName"]}
//                     type="text"
//                     fullWidthtype="email" class="form-control" placeholder="Enter Full Name"/>
...
//           type="text"
//           type={this.state.showPassword ? "text" : "password"} class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Password" data-toggle="password"/>
...
//           error={this.state.errorValid.mobilenumber}
//           placeholder="mobilenumber"
//           helperText={this.state.errors["mobilenumber"]}
//           type="text"
  
//           type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Mobile Number"/>
         
//           </div>
//           <button type="button" class="btn1 btn-danger"  onClick={(e) => this.onSubmit(e)}>Signup</button>
//           </div>
//           </form>
//           </div>
